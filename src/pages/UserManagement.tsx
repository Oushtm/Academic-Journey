    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12 text-white">
        ...
        <div className="relative z-10">
          <Link to="/profile" className="text-white/80 hover:text-white text-sm inline-block font-medium hover:underline mb-4 block">
            ← Back to Profile
          </Link>
          ...
          <div className="space-y-2 sm:space-y-3 mt-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">User Management</h2>
            <p className="text-base sm:text-lg md:text-xl text-primary-100 leading-relaxed">Create and manage user accounts • Admin only</p>
          </div>
        </div>
      </div>
